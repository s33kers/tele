...
//        assertEquals("foo", app.getItems()[0].getName());
    ...
    public void updateQuality_expectedResultAfter0Days() {
        ...
        assertEquals(TestUtils.updateForNumberOfDays(app, 0, createItems()), resultAfterDays);
    }
    ...
    public void updateQuality_expectedResultAfter5Days() {
        ...
        assertEquals(TestUtils.updateForNumberOfDays(app, 5, createItems()), resultAfterDays);
    }
    ...
    public void updateQuality_expectedResultAfter8Days() {
        ...
        assertEquals(TestUtils.updateForNumberOfDays(app, 8, createItems()), resultAfterDays);
    }
    ...
    public void updateQuality_expectedResultAfter111Days() {
        ...
        assertEquals(TestUtils.updateForNumberOfDays(app, 111, createItems()), resultAfterDays);
    }
